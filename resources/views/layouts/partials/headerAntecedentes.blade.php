...
<div class="navbar-nav">
    <nav>
        <ul>
            <h1>Paciente {{$ante_patologicos->paciente->nombre}} {{$ante_patologicos->appaterno}} {{$ante_patologicos->apmaterno}} </h1>
            ...
            <li><a href="{{route('consulta.index', $ante_patologicos->paciente_id)}} " class="{{request()->routeIs('consulta.*') ? 'active' : ''}}">Consultas</a></li>
        </ul>
    </nav>
</div>
