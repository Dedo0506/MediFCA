...
<link href="/sources/css/create.css" rel="stylesheet">
<div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="subsection-inline">
                        <div class="subsection">{{ __('Antecedentes patológicos') }}</div>
                        <form method="POST" action="{{ route('antecedentes.store') }}">
                            ...
                            <div class="card-body">
                                <div class="subsection-inline">
                                    <div class="card-header">{{ __('Antecedentes no patológicos') }}</div>
                            ...
                            <div class="card-body">
                                <div class="subsection-inline">
                                    <div class="card-header">{{ __('Antecedentes heredo familiares') }}</div>
                                    <div class="subsection">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col">
                            ...
                            <div class="card-body">
                                <div class="subsection-inline">
                                    <div class="card-header">{{ __('Antecedentes ginecológicos') }}</div>
                                    <div class="subsection">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <label class="form-label">
                                                        Especificación:
                                                        <textarea name="especificacion" rows="5">{{ old('especificacion') }}</textarea>
                                                    </label>
